...
# 配置参数
IMAGE_DIR="/Users/shhaofu/Code/cursor-projects/p-video-ffmpeg-capture/xu_lian_lian_video"
OUTPUT_DIR="/Users/shhaofu/Code/cursor-projects/p-video-ffmpeg-capture/xu_lian_lian_video_output"
...
get_effects_video() {
    ...
    local effects_video="./effects_output/final_merged_effects.mp4"
