...
# 配置参数
IMAGE_DIR="/Users/shhaofu/Code/cursor-projects/p-video-ffmpeg-capture/su_miao_video"
OUTPUT_DIR="/Users/shhaofu/Code/cursor-projects/p-video-ffmpeg-capture/su_miao_video_output"
